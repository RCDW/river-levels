...
- [0009 - Transform engine: dbt + DuckDB now, Azure hybrid at W6](0009-dbt-duckdb-azure-hybrid.md) (superseded by 0014)
...
- [0013 - Click-to-trace v1: pre-computed lineage JSON, DuckDB-WASM later](0013-precomputed-lineage-then-wasm.md) (superseded by 0017)
- [0014 - Azure read via the DuckDB azure extension, not httpfs](0014-azure-extension-over-httpfs.md)
- [0015 - Synapse serverless as a showcase query surface](0015-synapse-serverless-showcase.md)
- [0016 - Azure IaC: azurerm with separate Terraform state](0016-azure-iac-separate-state.md)
- [0017 - Click-to-trace v2: live DuckDB-WASM query, lineage.json as fallback](0017-click-to-trace-wasm-live-query.md)
- [0018 - Pipeline self-publishes fresh data to the edge](0018-pipeline-self-publishes-data.md)
- [0019 - Forecast is a transparent damped linear trend](0019-forecast-transparent-trend.md)
- [0020 - Cross-origin nav from the dashboard to the hub](0020-cross-origin-nav-to-hub.md)
